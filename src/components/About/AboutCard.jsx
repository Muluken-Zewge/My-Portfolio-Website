      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            ...
            <br />
            I have completed BSc degree in <span className="purple">Computer Engineering</span>, followed by an intensive <span className="purple">Andvanced Algorithms and Software Engineering</span> education from the renowned <a href="https://a2sv.org/" target="_blank" rel="noreferrer">A2SV(Africa To Silicon Valley)</a>. 
            <br />
